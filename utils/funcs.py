...
def load_video_batch(filepath_list, frame_stride, video_size=(256,256), video_frames=16):
    ...
    for filepath in filepath_list:
        ...
        max_valid_frames = total_frames // frame_stride
        if video_frames < 0:
            ## all frames are collected
            required_frames = total_frames // frame_stride
    ...
    return torch.stack(batch_tensor, dim=0), fps_list
